...
async function checkLogin() {
    // Safety net: if something goes wrong below and we never reach the
    // "auth-ready" line, reveal the page anyway after 4s instead of leaving
    // it blank forever.
    ...
    if (page.includes("login.html") || page.includes("maintenance.html") || page.endsWith("/") || page.endsWith("/frontend")) {
